    <div class="container-fluid dashboard-home">
        ...
        <div class="row my-5">
            ...
            <div class="col-xl-3 col-md-6 mb-4 my-5">
                <a class="link-underline link-underline-opacity-0" href="/controllers/dashboard/dungeons/donjons_dash_controller.php">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4 my-5">
                <a class="link-underline link-underline-opacity-0" href="/controllers/dashboard/guides/guides_dash_controller.php">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
